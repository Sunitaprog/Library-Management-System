...
class Window1:
  ...
  #===========================================================================================================================================
    ...
    def Login_System(self):
        ...
        if(u==str("sunita") and p==str(1234)):
...
class Library:
    ...
    def __init__(self,master):
        self.master=master
        self.master.title(" Vivakanand Library")
        self.master.geometry('1350x750+0+0')
        ...
        def iEliminate():
            msg=tkinter.messagebox.askyesno(" Vivakanand Library ", "Confirm if you want to exit")
            if msg=="True":
               master.quit()
        ...
        self.cboTitle['value']=('', 'Mr.', 'Miss.', 'Mrs.', 'Dr.', 'Ms.')
